module swap gcc-4.7.2 gcc-4.9.2
module load cmake/3.8.2
module load mpich/3.2-gcc4.9.2
export PATH=/home/sinclairg/Code/netcdfbuild/bin:$PATH
export CMAKE_SOURCE_DIR=../
export  NETCDF=$HOME/Code/netcdfbuild 
...
export LIBCONFIGPP_INCLUDE_DIRR=/home/sinclairg/Code/libconfigbuild/include
